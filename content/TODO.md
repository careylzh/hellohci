...
* [x] Add a toggle dark theme: use consolas on a dark background (background color same as the color theme Nord in vs.code). Done: top-right theme button toggles between Nord and the original warm theme; Nord uses Consolas on `#2e3440`.
